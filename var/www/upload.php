...
} else if (isset($_POST["submit"]) && $_POST["submit"] == "Restart System") {
	$htmlMainStr .= "System restarting - please wait <span id=timer>120 seconds</span>";
	exec("(sleep 5;/sbin/reboot) > /dev/null 2>&1 &");
	$system_restart = true;
} 
?>	
